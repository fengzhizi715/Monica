...
private val filters: MutableList<FilterParam> by lazy {
    mutableListOf<FilterParam>().apply {
        ...
        this.add(FilterParam("ColorFilter", mutableListOf<Triple<String,String,Any>>().apply {
        ...
        this.add(FilterParam("StrokeAreaFilter", mutableListOf<Triple<String,String,Any>>().apply {
